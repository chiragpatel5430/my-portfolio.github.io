...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://formspree.io/f/myyabbyp', formData, {
      ...
      <div className='row justify-content-between'>
        ...
        <div className='col-md-6 mb-5 mb-lg-0' data-aos='fade-up'>
          ...
          <div className='contact-map'>
            <iframe
              src='https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Surat%20Gujarat%20India+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed'
              frameBorder='0'
              allowFullScreen=''
              aria-hidden='false'
              title='Contact Me'
